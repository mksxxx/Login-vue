    ...
    <form @submit="Login" class="login-form">
        ...
        <div class="form-group">
            <div class="input-container">
                <q-input v-model="email" label="Digite seu email" type="email" autofocus />
            </div>
        </div>

        <div class="form-group">
            <div class="input-container">
                <q-input v-model="password" label="Digite sua senha" type="password" />
            </div>
        </div>
        <a href="#" class="forgot-password-link" @click.prevent="ResetPassword">Esqueci minha senha</a>
        
        <q-btn class="b" type="submit" color="primary" label="Entrar" />
...
.forgot-password-link {
    display: block; /* Para que ele ocupe uma linha inteira e o text-align funcione */
    text-align: right;
    margin-top: -15px; /* Puxa para cima para ficar mais próximo do campo de senha */
    margin-bottom: 20px; /* Espaço antes do botão Entrar */
    font-size: 0.9em;
